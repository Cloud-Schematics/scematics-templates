...
variable subnet_names {
  description = "A list of subnet names where VSI will be deployed. Must exist within the VPC"
  # type        = list(string)
  default     = [
    "asset-multizone-subnet-1",
    "asset-multizone-subnet-2",
    "asset-multizone-subnet-3"
  ]
}
